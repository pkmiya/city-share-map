...
def login(
    ...
    """
    # NOTE: OAuth2PasswordRequestForm は application/x-www-form-urlencoded を受け取るが、application/json を受け取るようにしたいので、LoginRequest を利用
    ...
    return UserToken(
        access_token=security.create_access_token(user.id, expires_delta=access_token_expires, user_type=user_type),
