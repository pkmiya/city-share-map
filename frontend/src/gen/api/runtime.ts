...
export const BASE_PATH = 'https://city-share-map.com:8000'.replace(/\/+$/, '');
...
export class BaseAPI {
  ...
  protected async request(
    ...
    // -----------------------------------------------------------------------------------
    // NOTE: バックエンドAPIからエラーメッセージが返却される場合、throwするエラーオブジェクトにセット
    let message = 'Response returned an error code';
    try {
